...
import Layout from '../components/Layout'; // Vérifie que le chemin vers ton Layout est correct
...
const PokemonCollection = () => {
    ...
    Papa.parse(SHEET_URL, {
      ...
      complete: (results) => {
        const filteredData = results.data.filter((row, index) => {
          ...
          // On ignore les lignes demandées et les lignes vides
  ...
  return (
    <Layout activePage="pokemon"> {/* On définit ici l'ID pour le menu */}
